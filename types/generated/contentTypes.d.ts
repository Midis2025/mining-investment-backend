...
export interface ApiCompanyRegisterationCompanyRegisteration
  extends Struct.CollectionTypeSchema {
...
export interface ApiEventEditionEventEdition
  extends Struct.CollectionTypeSchema {
  collectionName: 'event_editions';
  info: {
    displayName: 'Event Edition';
    pluralName: 'event-editions';
    singularName: 'event-edition';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-edition.event-edition'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    year: Schema.Attribute.Enumeration<
      ['Year 2027', 'Year 2028', 'Year 2029', 'Year 2030']
    >;
  };
}
...
export interface ApiMediaPartnerMediaPartner
  extends Struct.CollectionTypeSchema {
...
export interface ApiParticipatingCompanyParticipatingCompany
  extends Struct.CollectionTypeSchema {
  collectionName: 'participating_companies';
  info: {
    displayName: 'participating-company';
    pluralName: 'participating-companies';
    singularName: 'participating-company';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    commodities: Schema.Attribute.JSON;
    companyName: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    event_edition: Schema.Attribute.Relation<
      'oneToOne',
      'api::event-edition.event-edition'
    >;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::participating-company.participating-company'
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.String;
    logo: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
